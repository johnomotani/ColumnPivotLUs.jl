...
export row_pivoting_lu!, column_pivoting_lu!
...
function row_pivoting_lu!(A::AbstractMatrix, ipiv::AbstractVector{<:Integer})
    _row_pivoting_lu!(A, ipiv, size(A, 1), size(A, 2))
    return A
end

function _row_pivoting_lu!(A::AbstractMatrix, ipiv::AbstractVector{<:Integer},
                           m::Integer, n::Integer)
    ...
    @inbounds begin
        ...
        elseif n == 1
            ...
            # [ --- ]
            # [ A21 ]
            _row_pivoting_lu!(@view(A[:,1:n1]), ipiv, m, n1)
            ...
            _row_pivoting_lu!(A22, bottom_ipiv, m2, n2)
...
function column_pivoting_lu!(A::AbstractMatrix, jpiv::AbstractVector{<:Integer})
    _column_pivoting_lu!(A, jpiv, size(A, 1), size(A, 2))
    return A
end

function _column_pivoting_lu!(A::AbstractMatrix, jpiv::AbstractVector{<:Integer},
                              m::Integer, n::Integer)
    # A - the matrix being factorised in-place.
    ...
    @inbounds begin
        ...
        elseif m == 1
            ...
            # Factor
            # [ A11 | A12 ]
            _column_pivoting_lu!(@view(A[1:m1,:]), jpiv, m1, n)
            ...
            _column_pivoting_lu!(A22, right_jpiv, m2, n2)
